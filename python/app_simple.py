"""
Simple standalone version - No Redis or complex dependencies needed
"""
...
app = Flask(__name__)
CORS(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///sentiment_simple.db'
...
# Import services (lazy loading to avoid import errors)
analyzer = None
scraper = None
